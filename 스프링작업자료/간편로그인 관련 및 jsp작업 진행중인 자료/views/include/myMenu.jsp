...
<div class="myMenu">
    ...
    <div id="my_menu">
        <div id="my_menu_list">
            <ul>
                <li><a class="topmenu" href="/mypage/myList.do">주문내역 조회</a></li>
                <li><a class="topmenu" href="/mypage/myCart.do">장바구니</a></li>
                <li><a class="topmenu" href="membership.do">나의 등급</a></li>
                <li><a class="topmenu" href="/mypage/myReview.do">나의 후기</a></li>
                <li><a class="topmenu" href="/mypage/myInfo.do">회원정보 변경</a></li>
            </ul>
        </div>
    </div><!--my_menu-->
