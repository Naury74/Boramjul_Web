...
<body>
 ...
 <div class="header">
        ...
        <div id="top_menu">
            <ul>
                <li><a href="login.do" class="topmenu">로그인</a></li>
                <li><a href="join.do" class="topmenu">회원가입</a></li>
                <li><a href="cart.do" class="topmenu">카트</a></li>
        ...
        <div id="main_menu">
                ...
                <!-- 
                    ...
                    <li><a href="membership.do" class="topmenu">MEMBERSHIP</a></li>
                </ul>
        </div><!--main_menu-->
