...
<head>
 <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="../css/join1_1.css">
</head>
<body>
<div id="box1">
    ...
    <a id="main">이용약관</a>
    <div id="box2">
        <a>＊제1조(목적) 이 약관은 보람줄이 운영하는 보람줄 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
            ...
            ① “몰”이란 보람줄 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
            ...
            ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</a>
        </div>
